...
describe('Verification controller', () => {
  ...
  describe('handleResetField', () => {
    ...
    it('should correctly call service when params are valid', async () => {
      ...
      await VerificationController.handleResetField(MOCK_REQ, mockRes, noop)
  ...
  describe('handleGetOtp', () => {
    ...
    it('should call service correctly when params are valid', async () => {
      await VerificationController.handleGetOtp(MOCK_REQ, mockRes, noop)
  ...
  describe('handleVerifyOtp', () => {
    ...
    it('should call service correctly when params are valid', async () => {
      await VerificationController.handleVerifyOtp(mockReq, mockRes, noop)
