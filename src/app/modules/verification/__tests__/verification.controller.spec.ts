...
describe('Verification controller', () => {
  ...
  describe('handleGetOtp', () => {
    ...
    beforeEach(() => {
      ...
      MockVerificationService.sendNewFormOtp.mockReturnValue(
        okAsync(mockTransaction),
      )
    })
    ...
    it('should call service correctly when params are valid', async () => {
      ...
      expect(MockVerificationService.sendNewFormOtp).toHaveBeenCalledWith(
    ...
    it('should return 404 when transaction is not found', async () => {
      MockVerificationService.sendNewFormOtp.mockReturnValueOnce(
        errAsync(new TransactionNotFoundError()),
      )
    ...
    it('should return 500 when error occurs while hashing', async () => {
      ...
      expect(MockOtpUtils.generateOtpWithHash).toHaveBeenCalled()
      expect(MockVerificationService.sendNewFormOtp).not.toHaveBeenCalled()
      expect(mockRes.status).toHaveBeenCalledWith(
        StatusCodes.INTERNAL_SERVER_ERROR,
      )
      expect(mockRes.json).toHaveBeenCalledWith({ message: expect.any(String) })
  ...
  describe('handleVerifyOtp', () => {
    ...
    beforeEach(async () => {
      MockVerificationService.verifyFormOtp.mockReturnValue(
    ...
    it('should call service correctly when params are valid', async () => {
      ...
      expect(MockVerificationService.verifyFormOtp).toHaveBeenCalledWith(
    ...
    it('should return 404 when transaction is not found', async () => {
      MockVerificationService.verifyFormOtp.mockReturnValueOnce(
        errAsync(new TransactionNotFoundError()),
      )
  ...
  describe('_handleOtpVerification', () => {
    ...
    it('should return 404 when the form could not be found', async () => {
      ...
      expect(MockVerificationService.verifyFormOtp).not.toHaveBeenCalled()
      expect(mockRes.status).toHaveBeenCalledWith(StatusCodes.NOT_FOUND)
      expect(mockRes.json).toHaveBeenCalledWith(expectedResponse)
    })
