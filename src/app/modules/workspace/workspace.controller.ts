...
> = async (req, res) => {
  ...
  return WorkspaceService.getWorkspace(sourceWorkspaceId)
    .andThen((sourceWorkspace) =>
      WorkspaceService.verifyWorkspaceAdmin(sourceWorkspace, userId),
    )
    .andThen(() => WorkspaceService.getWorkspace(destWorkspaceId))
