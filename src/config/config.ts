...
const dbConfig: DbConfig = {
  uri: configuration.get('core.dbHost'),
  options: {
    user: '',
    pass: '',
...
const mailConfig: MailConfig = (function () {
  ...
  if (!isDev) {
    ...
    const options: SMTPPool.Options = {
      ...
      pool: true,
      maxMessages: configuration.get('mail.maxMessages'),
      maxConnections: configuration.get('mail.maxConnections'),
      socketTimeout: configuration.get('mail.socketTimeout'),
...
const config: Config = {
  ...
  customCloudWatchGroup: configuration.get('awsConfig.customCloudWatchGroup'),
  bounceLifeSpan: configuration.get('mail.bounceLifeSpan'),
  chromiumBin: configuration.get('mail.chromiumBin'),
  port: configuration.get('core.port'),
  sessionSecret: configuration.get('core.sessionSecret'),
  otpLifeSpan: configuration.get('core.otpLifeSpan'),
  cspReportUri: configuration.get('core.cspReportUri'),
  submissionsTopUp: configuration.get('core.submissionsTopUp'),
