...
export const useWorkspaceMutations = () => {
  ...
  const deleteFormFromWorkspacesMutation = useMutation(
    (params: { formId: string }) => deleteFormFromWorkspaces(params),
    {
      onSuccess: () =>
  ...
  return {
    ...
    deleteFormFromWorkspacesMutation,
  }
}
