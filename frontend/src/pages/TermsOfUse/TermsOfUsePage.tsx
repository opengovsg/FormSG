...
export const TermsOfUsePage = (): JSX.Element => {
  return (
    <Container color="secondary.700" maxW="85ch" p="1rem">
      <Stack spacing="5rem">
        <Box as="section">
          ...
          <OrderedList spacing="1.5rem" marginInlineStart="1.5rem">
            ...
            <SectionListItem>
              ...
              <SubSectionOrderedList>
                ...
                <SubSectionListItem>
                  ...
                  and use the Service for personal or internal purposes only,
                  and only for such use permitted by the functions of the
                  Service and intended by GovTech. You shall not, amongst other
                  things, benchmark, reproduce, modify, reverse-engineer,
                  decompile, adapt, publish, redistribute or sublicense the
                  Service or any part of the Service without the prior written
                  consent of GovTech or the respective third party owners. You
                  also shall not use the Service in violation of any applicable
                  laws or agreements that you have with any third parties. All
                ...
                <SubSectionListItem>
                  ...
                  <SubSubSectionOrderedList>
                    ...
                    <SubSectionListItem>
                      ...
                      notice or liability to you whatsoever, whereupon all
                      rights granted to you hereunder shall also terminate
                ...
                <SubSectionListItem>
                  ...
                  working of the Service or otherwise do anything that imposes
                  an unreasonable or disproportionately large load on GovTech’s
                  servers.
                </SubSectionListItem>
              </SubSectionOrderedList>
            </SectionListItem>
            <SectionListItem listStyleType="'3A. '">
              ...
              <SubSectionOrderedList>
                ...
                <SubSectionListItem>
                  ...
                  the foregoing, GovTech is not under any duty to verify that
                  any biometric identifier used with the Service, or on your
                ...
                <SubSectionListItem>
                  ...
                  rely on any instructions, information, transmissions of data,
                  or communications received from the account or use of the
                  Service in relation to your authentication credentials, as if
                  such instructions, information, data or communications were
                  issued by you, whether or not the same was authorized by you.
                </SubSectionListItem>
                <SubSectionListItem>
                  For the avoidance of doubt, you are solely responsible for any
                  loss of whatever nature arising from unauthorized or
                  unofficial modifications made to your device which permit or
                  escalate privileged access, or remove restrictions to such
                  access, which are not intended by the manufacturer or provider
                  of your device or operating system of your device (e.g.,
                  "rooting" or "jailbreaking" your mobile phone).
                </SubSectionListItem>
              </SubSectionOrderedList>
            </SectionListItem>
            <SectionListItem listStyleType="'4. '">
              ...
              <SubSectionOrderedList>
                ...
                <SubSectionListItem>
                  ...
                  <SubSubSectionOrderedList>
                    <SubSectionListItem>
                      ...
                      licence is a direct licence from the Third Party to you;
                      and
                    </SubSectionListItem>
                    <SubSectionListItem>
                ...
                <SubSectionListItem>
                  ...
                  standards herein, and/or terms described in Clause 4.e below),
                ...
                <SubSectionListItem>
                  ...
                  GovTech to grant the Third Party, direct rights of enforcement
                  of these Terms of Use as a third party beneficiary, against
                  you. Such Third Party Terms are deemed to have been
                  incorporated into these Terms of Use as Incorporated Terms,
                  and you hereby agree to grant such Third Party, such direct
                  rights of enforcement against you.
                </SubSectionListItem>
                <SubSectionListItem>
                  For the avoidance of doubt, without prejudice to Clause 4.d,
                  to the extent of any inconsistency between these Terms of Use
                  and the Third Party Terms, the latter shall prevail provided
                  nothing in the Third Party Terms increases the liability of
            ...
            <SectionListItem listStyleType="'5B. '">
              ...
              <SubSectionOrderedList>
                ...
                <SubSectionListItem>
                  <Text mb="1.5rem">In the event:</Text>
                  <SubSubSectionOrderedList>
                    <SubSectionListItem>
              ...
              <SubSectionOrderedList>
                <SubSectionListItem>
                  <Text fontWeight="bold" mb="1.5rem">
                    ...
                    permitted by law, GovTech does not make any representations
                    or warranties of any kind whatsoever in relation to the
                    Service and hereby disclaims all express, implied and/or
                    statutory warranties of any kind to you or any third party,
                  ...
                  <SubSubSectionOrderedList>
                    ...
                    <SubSectionListItem>
                      <b>
                        ...
                        will be corrected or that this Service, website and the
                        server are and will be free of all viruses and/or other
                ...
                <SubSectionListItem>
                  <Text fontWeight="bold" mb="1.5rem">
                    ...
                    for any damage or loss of any kind whatsoever and howsoever
                    caused, including but not limited to any direct or indirect,
                    special or consequential damages, loss of income, revenue or
                    profits, lost or damaged data, or damage to your computer,
                ...
                <SubSectionListItem>
                  <b>
                    Without prejudice and in addition to the foregoing, insofar
                    as the Service facilitates or requires the provision, use or
                    functioning of, or is provided in conjunction with, other
                    products, software, materials and/or services not provided
                    by GovTech, GovTech makes no representation or warranty in
                    relation to such products, software, materials and/or
                    services (including without limitation any representation or
                    warranties as to timeliness, reliability, availability,
                ...
                <SubSectionListItem>
                  ...
                  whether or not arising out of or in connection with GovTech’s
                ...
                <SubSectionListItem>
                  ...
                  all liabilities, losses, damages, costs or expenses (including
                  legal costs on an indemnity basis) howsoever arising out of or
                  in connection with your access or use of the Service
                  (including third party software or services) or your
                  non-compliance with the Terms of Use, Third Party Terms or
                  Incorporated Terms, whether or not you had been advised or
                  informed of the nature or extent of such liabilities, losses,
                  damages, costs or expenses. You warrant and represent that
                  your access or use of the Service does not and will not breach
                  or violate any laws, regulations, trade, economic and/or
                  export sanctions (wherever in the world) applicable to you,
                  and that you shall not transmit any malicious code, illegal,
                  infringing or undesirable content or materials to GovTech or
                  its agents or any Third Party.
                </SubSectionListItem>
                <SubSectionListItem>
                  <Text mb="1.5rem">
                  ...
                  <SubSubSectionOrderedList>
                    <SubSectionListItem>
                      ...
                      you exceed the amount of fees or payment received by
                    ...
                    <SubSectionListItem>
                      ...
                      out of or in connection with these Terms of Use more than
            ...
            <SectionListItem listStyleType="'7. '">
              ...
              <SubSectionOrderedList>
                <SubSectionListItem>
                  ...
                  access to the hyperlinked material. Use of the hyperlinks and
                  access to such hyperlinked materials are entirely at your own
                  risk. The hyperlinks are provided merely as a convenience to
                  you and do not imply endorsement by, association or
                  affiliation with GovTech of the contents of or provider of the
                ...
                <SubSectionListItem>
                  ...
                  to any conditions as may be determined by GovTech in its sole
                  discretion. If you hyperlink to or frame any part of the
                  Service, that shall constitute your acceptance of these Terms
                  of Use and all amendments thereto. If you do not accept these
                  Terms of Use as may be amended from time to time, you must
                  immediately discontinue linking to or framing of any part of
                  the Service.
                </SubSectionListItem>
                <SubSectionListItem>
                  <Text mb="1.5rem">GovTech reserves all rights:</Text>
                  <SubSubSectionOrderedList>
                    <SubSectionListItem>
                      ...
                      topics, names, or information that violates any written
                      law, any applicable intellectual property, proprietary,
                      privacy or publicity rights); and
                    </SubSectionListItem>
                    <SubSectionListItem>
              ...
              <SubSectionOrderedList>
                ...
                <SubSectionListItem>
                  ...
                  <Text mt="1.5rem">
                    ...
                    given at least 30 days before the commencement of any legal
                    action against it to elect to exercise the right herein to
                    have the dispute submitted to arbitration. This right to
                    elect shall not prejudice GovTech’s right to a limitation
                    defence and the period to exercise the right shall not be
                    abridged by reason of any accrual of a limitation defence in
          ...
          <OrderedList spacing="1.5rem" marginInlineStart="1.5rem">
            ...
            <SectionListItem>
              ...
              <SubSectionOrderedList>
                ...
                <SubSectionListItem>
                  This Service is a form builder tool for the permitted entities
                  (listed in sub-paragraph (a.) above) to build their own online
                  forms.
                </SubSectionListItem>
                <SubSectionListItem>
                  Please note that GovTech may collect, store and/or process
                  data that you collect using the forms created by the Service.
                </SubSectionListItem>
                <SubSectionListItem>
                  You are responsible for any issues concerning the forms you
                  create and for replying to and/or dealing with the form
                  respondent or any other person concerning your form, including
                  without limitation the use, linking, or publication of your
                  own privacy policy/statement applying to the form. GovTech is
                  not responsible for your compliance with the applicable rules
                  or laws, or for any failure by you to provide a privacy
                  policy/statement.
                </SubSectionListItem>
                <SubSectionListItem>
                ...
                <SubSectionListItem>
                  ...
                  the form creator. GovTech’s Privacy Policy will also apply to
                  you.
                </SubSectionListItem>
                <SubSectionListItem>
                  GovTech’s Terms of Use and Privacy Policy apply in addition to
                  any terms or privacy policy/statement of the form creator.
                </SubSectionListItem>
              </SubSectionOrderedList>
            </SectionListItem>
            <SectionListItem>
              ...
              <SubSectionOrderedList>
                <SubSectionListItem>
                  <Text>
                    Please see this{' '}
                    <Link
                      href="https://s3-ap-southeast-1.amazonaws.com/misc.form.gov.sg/OSS-Legal.pdf"
                      isExternal
                    >
                      link
                    </Link>{' '}
