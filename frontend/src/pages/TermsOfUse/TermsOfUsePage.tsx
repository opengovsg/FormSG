...
export const TermsOfUsePage = (): JSX.Element => {
  return (
    <Flex flexDir="column">
      <Container color="secondary.700" maxW="85ch" px="1rem" pb="5rem" flex={1}>
        <Stack spacing="5rem">
          <Box as="section">
