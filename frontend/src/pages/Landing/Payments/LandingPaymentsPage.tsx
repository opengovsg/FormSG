      ...
      if (error instanceof Error) {
        if (error.message === 'Forbidden') {
          formMethods.setError(fieldId, {
            message:
              'We are unable to send you our guide because your email is not whitelisted on Form Playground.',
          })
        } else {
          formMethods.setError(fieldId, {
        ...
        >
          ...
          <HelpAccordionItem title="Is there an invoice or receipt provided?">
            <Text>
              ...
              invoice generated by Form Playground upon successful payment.
              Invoices will be sent to respondents for payment amounts less than
              S$1000.
            </Text>
          </HelpAccordionItem>
