...
export const types: MyInfoFieldBlock[] = [
  ...
  {
    name: MyInfoAttribute.DrivingLicenceTotalDemeritPoints,
    value: 'Driving Licence Total Demerit Points',
    category: 'personal',
    verified: [],
    source: 'Land Transport Authority',
    description: 'The total demerit points of the form-filler.',
    fieldType: BasicField.ShortText,
    previewValue: '12',
  },
  {
    name: MyInfoAttribute.DrivingLicenceSuspensionStartDate,
    ...
    description: 'The certificate of merit status of the form-filler.',
    fieldType: BasicField.ShortText,
    previewValue: '2019-07-01',
  },
  {
    name: MyInfoAttribute.DrivingLicenceSuspensionEndDate,
    value: 'Driving Licence Suspension Start Date',
    category: 'personal',
    verified: [],
    source: 'Land Transport Authority',
    description: 'The suspension start date of the form-filler.',
    fieldType: BasicField.ShortText,
    previewValue: '2019-03-31',
  },
  {
    name: MyInfoAttribute.DrivingLicenceDisqualificationStartDate,
    value: 'Driving Licence Suspension End Date',
    category: 'personal',
    verified: [],
    source: 'Land Transport Authority',
  ...
  {
    name: MyInfoAttribute.DrivingLicenceQdlClasses,
    value: 'Driving Licence Qualified Driving Licence Class',
    category: 'personal',
    verified: [],
    source: 'Land Transport Authority',
    description: 'The licence class of the form-filler.',
    fieldType: BasicField.ShortText,
    previewValue: '3',
  },
  {
    name: MyInfoAttribute.DrivingLicenceQdlValidity,
    value: 'Driving Licence Qualified Driving Licence Validity',
    category: 'personal',
    verified: [],
    source: 'Land Transport Authority',
    description: 'The licence validity of the form-filler.',
    fieldType: BasicField.ShortText,
    previewValue: '2020-03-31',
  },
  {
    name: MyInfoAttribute.DrivingLicenceQdlExpiryDate,
    value: 'Driving Licence Qualified Driving Licence Expiry Date',
    category: 'personal',
    verified: [],
    source: 'Land Transport Authority',
    description: 'The driving licence of the form-filler.',
    fieldType: BasicField.ShortText,
    previewValue: '2020-03-31',
  },
  {
    name: MyInfoAttribute.DrivingLicencePhotocardSerialNo,
    value: 'Driving Licence Photo Card Serial Number',
    category: 'personal',
    verified: [],
    source: 'Land Transport Authority',
    description: 'The photocard serial number of the form-filler.',
    fieldType: BasicField.ShortText,
    previewValue: '445566',
  },
  {
