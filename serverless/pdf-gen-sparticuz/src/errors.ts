...
export class PdfLoadingError extends Error {
  constructor(
    message = 'Error loading PDF: Failed to load PDF into Chromium',
    error?: Error,
  ) {
    super(message)
...
export class PdfGenerationError extends Error {
  constructor(
    message = 'Error generating PDF: Failed to convert HTML to PDF',
    error?: Error,
  ) {
    super(message)
...
export class PuppeteerChromiumError extends Error {
  constructor(
    message = 'Error with Puppeteer Chromium operation occurred',
    error?: Error,
  ) {
    super(message)
