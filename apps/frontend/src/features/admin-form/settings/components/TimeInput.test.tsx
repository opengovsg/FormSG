...
/** Shapes an admin can reasonably type and expect to be understood on blur. */
...
/**
 * Whatever the admin types, the text shown back and the toggle beside it must
 * re-parse to the same instant, or blurring twice would walk the value.
 */
...
/** The same behaviour, driven through the rendered field. */
describe('<TimeInput />', () => {
  ...
  it('should leave keystrokes alone while the admin is still typing', async () => {
    ...
    // Nothing is reformatted until blur.
