  ...
  return (
    <Html>
      ...
      <Body>
        ...
        <Text>
          Your <b>{formTitle}</b> (<a href={formLink}>{formLink}</a>) has been
          closed to new responses because it has exceeded the number of free
          SMSes. Please fill out this form (
          <a href={SUPPORT_FORM_LINK}>go.gov.sg/formsg-support</a>) to reach out
          to the FormSG support team.
        </Text>
