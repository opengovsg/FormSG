describe('config', () => {
  ...
  describe('SUBMISSION_HISTORY_V1_S3_BUCKET', () => {
    it('should throw on boot when SUBMISSION_HISTORY_V1_S3_BUCKET is not set', () => {
      // Arrange
    ...
    it('should expose SUBMISSION_HISTORY_V1_S3_BUCKET as aws.submissionHistoryV1S3Bucket when set', () => {
      // Arrange
      process.env.SUBMISSION_HISTORY_V1_S3_BUCKET =
        'local-submission-history-v1-bucket'
  ...
  describe('SUBMISSION_HISTORY_V1_ATTACHMENT_S3_BUCKET', () => {
    it('should throw on boot when SUBMISSION_HISTORY_V1_ATTACHMENT_S3_BUCKET is not set', () => {
      // Arrange
    ...
    it('should expose SUBMISSION_HISTORY_V1_ATTACHMENT_S3_BUCKET as aws.submissionHistoryV1AttachmentS3Bucket when set', () => {
      // Arrange
      process.env.SUBMISSION_HISTORY_V1_ATTACHMENT_S3_BUCKET =
        'local-submission-history-v1-attachment-bucket'
