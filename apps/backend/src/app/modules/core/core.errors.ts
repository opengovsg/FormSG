...
export enum ErrorCodes {
  ...
  ADMIN_FORM_WORKFLOW_DELETION_DISABLED = 100116,
  ADMIN_FORM_DELETE_FIRST_WORKFLOW_STEP = 100117,
  ...
  SUBMISSION_EMAIL_HASH = 100223, // Email submission error (email mode deprecated soon)
  ...
  SUBMISSION_GD_INVALID_FILE_KEY = 100228,
  SUBMISSION_GD_VIRUS_SCAN_FAILED = 100229,
  SUBMISSION_GD_DOWNLOAD_CLEAN_FILE_FAILED = 100230,
  ...
  SUBMISSION_MRF_SNAPSHOT_WRITE = 100238,
  SUBMISSION_MRF_SNAPSHOT_DATA_INTEGRITY = 100239,
  SUBMISSION_MRF_SNAPSHOT_READ = 100240,
  SUBMISSION_MRF_SNAPSHOT_ACCESS_DENIED = 100241,
  SUBMISSION_MRF_SNAPSHOT_FORMAT_NOT_RECORDED = 100242,
  SUBMISSION_GD_FILE_ALREADY_SCANNED = 100243,
  SUBMISSION_MRF_V1_CONTENT_MAPPING = 100244,
  SUBMISSION_MRF_V1_SNAPSHOT_REQUIRED = 100245,
  ...
  // 110300, 110301, 110305, 110308, 110309 are deprecated MyInfo v3 errors
  ...
  MYINFO_FAPI_CONFIG = 110310,
  MYINFO_FAPI_MISSING_SESSION = 110311,
  MYINFO_FAPI_AUTH_REQUEST = 110312,
  MYINFO_FAPI_EXCHANGE = 110313,
  MYINFO_FAPI_FETCH = 110314,
  MYINFO_FAPI_MISSING_UINFIN = 110315,
  MYINFO_FAPI_INCOMPLETE_LOGIN = 110316,
  MYINFO_FAPI_SESSION_FORM_MISMATCH = 110317,
  ...
  PAYMENT_STRIPE_METADATA_NOT_FORMSG = 130110,
  ...
  VERIFICATION_OTP_JWT_ERROR = 150012,
