  ...
  Object.fromEntries(
    applyMyInfoPrefix(
      flattenV4ToFormFields({
        // No logic on this fixture, so every field counts as shown. The term
        // is mandatory on the flatten: omitting it reads every field's
        // visibility off `undefined.length`.
        formLogics: [],
