...
describe('spcp.oidc.service', () => {
  ...
  describe('createRedirectUrl', () => {
    it('should call cp oidc client createRedirectUrl with a code challenge and return the code verifier', async () => {
      // Arrange
  ...
  describe('extractJwtPayloadFromRequest', () => {
    it('should return a CP JWT payload when there is a valid JWT in the request', async () => {
      ...
      // Act
      const result =
        await cpOidcServiceClass.extractJwtPayloadFromRequest(MOCK_COOKIES)
