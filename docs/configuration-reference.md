---
description: >-
  Complete guide to all FormSG environment variables, configuration options, and
  deployment settings.
---
...
1. **`.env.example` file** - Complete reference of all available variables (copy to `.env` for local development)
2. **GitHub Actions Secrets** - For deployment automation
3. **AWS Systems Manager Parameter Store** - For environment-specific configuration
4. **Environment Variables** - Direct configuration in your deployment environment
