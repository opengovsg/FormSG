...
// optional. Additionally, we have to add a single quote in front
// of the CSV field if the value is not a pure number to prevent
// formula injection. Hence we treat checkbox, table and radiobutton
