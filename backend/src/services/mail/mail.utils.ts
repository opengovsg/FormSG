...
export const generateLoginOtpHtml = (htmlData: {
  ...
  const pathToTemplate = `${process.cwd()}/src/views/templates/otp-email.server.view.html`
...
export const generateSubmissionToAdminHtml = (
  ...
  const pathToTemplate = `${process.cwd()}/src/views/templates/submit-form-email.server.view.html`
  return safeRenderFile(pathToTemplate, htmlData)
}
...
export const generateBounceNotificationHtml = (
  ...
  if (bounceType === BounceType.Permanent) {
    pathToTemplate = `${process.cwd()}/src/views/templates/bounce-notification-permanent.server.view.html`
  } else {
    pathToTemplate = `${process.cwd()}/src/views/templates/bounce-notification-transient.server.view.html`
  }
...
export const generateAutoreplyPdf = (
  ...
  const pathToTemplate = `${process.cwd()}/src/views/templates/submit-form-summary-pdf.server.view.html`
...
export const generateAutoreplyHtml = (
  ...
  const pathToTemplate = `${process.cwd()}/src/views/templates/submit-form-autoreply.server.view.html`
  return safeRenderFile(pathToTemplate, htmlData)
}
